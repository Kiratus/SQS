...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
	...
	if(dialogid == 2057)
	{
		if(response)
		{
		    if(IsPlayerInAnyVehicle(playerid)) return GameTextForPlayer(playerid, "~r~Saia do veículo atual!", 5000, 5);
			...
			if(listitem == 1) veh = CreateVehicle(464,x+1,y+1,z,a,1,1,10000);
	...
	if(dialogid == 2012)
	{
		if(response)
		{
			...
			if(listitem == 6) veh = CreateVehicle(425,x+1,y+1,z,a,1,1,10000);
	...
	if(dialogid == 2011)
	{
		if(response)
		{
			...
			if(listitem == 2) veh = CreateVehicle(520,x+1,y+1,z,a,1,1,10000);
			...
			if(listitem == 9) veh = CreateVehicle(476,x+1,y+1,z,a,1,1,10000);
	...
	if(dialogid == 2052)
	{
		if(response)
		{
			...
			if(listitem == 15) veh = CreateVehicle(432,x+1,y+1,z,a,1,1,10000);
